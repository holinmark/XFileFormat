...
#LINK = link.exe /NXCOMPAT /DYNAMICBASE /DEBUG:FASTLINK /NOLOGO /TLBID:1 /MACHINE:X64 ole32.lib user32.lib D3D11.lib kernel32.lib gdi32.lib winspool.lib advapi32.lib shell32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib
...
clean:
	@echo cleaning ...
	del $(OBJECTS_DIR)\\cXFile.obj $(OBJECTS_DIR)\\SkinInfo.obj $(OBJECTS_DIR)\\sFileIO.obj $(OBJECTS_DIR)\\stdafx.obj $(OBJECTS_DIR)\\sErrorMessageException.obj $(OBJECTS_DIR)\\sMeshList.obj $(OBJECTS_DIR)\\sMaterialList.obj $(OBJECTS_DIR)\\sAnimationSet.obj $(OBJECTS_DIR)\\sFrameList.obj $(OBJECTS_DIR)\\sFunctionCallHistory.obj $(OBJECTS_DIR)\\cTextXFileParser.obj $(OBJECTS_DIR)\\XFileParser.obj app.exe
